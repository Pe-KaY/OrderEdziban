      ...
      items: [
        {
          ...
          description:
            "Organic greens, heritage tomatoes, cucumber, with proprietary dressing.",
          price: 9.95,
          image:
        ...
        },
        {
          ...
          description:
            "Toasted sourdough topped with diced tomatoes, fresh basil, and aged balsamic glaze.",
          price: 8.95,
          image:
      ...
      items: [
        {
          ...
          description:
            "Premium mozzarella, vine-ripened tomatoes, fresh basil on house-crafted sourdough foundation.",
          price: 14.95,
          image:
        ...
        },
        {
          ...
          description:
            "Responsibly sourced salmon with organic quinoa and seasonal vegetable accompaniment.",
          price: 22.95,
          image:
                ...
                {cart.length === 0 ? (
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 mb-4 flex flex-col items-center justify-center text-center">
                    ...
                    <p className="text-sm text-gray-400">
                      Drag items here to build your meal
                    </p>
                  </div>
                ) : (
